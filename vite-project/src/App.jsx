...
const UserLayout = () => {
  ...
  const validTabPaths = ['/', '/create', '/help', '/know-hub', '/profile', '/admin/articles'];
    ...
    <>
      <Box sx={{
        ...
        <Container maxWidth="lg" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          >
            <Tab label="My Tickets" value="/" to="/" component={Link} sx={{ textTransform: "none" }}/>
            <Tab label="Create Ticket" value="/create" to="/create" component={Link} sx={{ textTransform: "none" }}/>
            <Tab label="Help Centre" value="/help" to="/help" component={Link} sx={{ textTransform: "none" }}/>
            <Tab label="Know Hub" value="/know-hub" to="/know-hub" component={Link} sx={{ textTransform: "none" }}/>
            <Tab label="Profile" value="/profile" to="/profile" component={Link} sx={{ textTransform: "none" }}/>
            {user && user.user.role === 'Admin' && (
                <Tab label="Admin" value="/admin/dashboard" to="/admin/dashboard" component={Link} sx={{ textTransform: "none" }}/>
            )}
          </Tabs>
